...
//   	* Класс DerivedClassB должен быть виден классам только из текущей сборки.
...
abstract public class BaseClass
{
	...
	abstract protected string GetClassSymbol();
}
...
class DerivedClassB : DerivedClassA
{
	...
	public string GetCode() { return DerivedClassImpl.GetCode(); }
	override protected string GetDefaultDescription() { return string.Empty; }
